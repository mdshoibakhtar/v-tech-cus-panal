...
function AuctionPurchaseHistory() {
  return (
    <>
            ...
            >
              ...
              <tbody>
                <tr>
                  ...
                  <td style={{ display: "table-cell" }}>09-12-2022</td>
                  ...
                  >
                    <Link
                      to="/customer/auction-purchase-history/details-page"
                ...
                <tr>
                  ...
                  <td style={{ display: "table-cell" }}>03-11-2022</td>
                ...
                <tr>
                  <td
                    ...
                    style={{ display: "table-cell" }}
                  >
                    <a href="https://mmslfashions.in/purchase_history/details/eyJpdiI6IllVWkZvV3hPcFgwd2M0aERveGlGeEE9PSIsInZhbHVlIjoiTFdqVHZoc3B4ay9iZ0JQeDhPaGRNZz09IiwibWFjIjoiOTA4MDVmMzA1MDBjOGU2ZTJlMTExYzNjNmUxZjE4MjUxNTU2MDdiMTlhMTM3YjBkNTc4NGM4YjU5NWY1ZGY4NCIsInRhZyI6IiJ9">
                      20221006-19574683
                    </a>
                  </td>
                  ...
                  >
                    <a
                      href="javascript:void(0)"
                      className="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                      data-href="https://mmslfashions.in/purchase_history/destroy/2"
                      title="Cancel"
                    >
                      <i className="las la-trash" />
                    </a>
                ...
                <tr>
                  <td
                    ...
                    style={{ display: "table-cell" }}
                  >
                    <a href="https://mmslfashions.in/purchase_history/details/eyJpdiI6IkQ4ZEJYM3NiMkQ1Z2srTzVnZHlaTVE9PSIsInZhbHVlIjoiYVpYWGduK0E4cjUrZEVOaFVOK2ZtQT09IiwibWFjIjoiODE5OGY4MGQ2N2YxYWFhNTI5YjJhYzIwMGEyOTI3NGFkODhiYmI4MTIwNGMzODM4NWZjZmEyOWYwMzk3N2VjOCIsInRhZyI6IiJ9">
                      20221006-19574668
                    </a>
                  </td>
                  <td style={{ display: "table-cell" }}>06-10-2022</td>
                  ...
                  >
                    <a
                      href="javascript:void(0)"
                      className="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                      data-href="https://mmslfashions.in/purchase_history/destroy/1"
                      title="Cancel"
                    >
                      <i className="las la-trash" />
                    </a>
...
export default AuctionPurchaseHistory;
